...
class Notifications extends StatelessWidget {
  String day = "Today";
  static const IconData pencil = IconData(0xf37e, fontFamily: "CupertinoIcons", fontPackage: 'cupertino_icons');
  int _selectedIndex = 1; // Initial index for Chats screen

  final int itemCount = 2; // Number of times to print the list
